  ...
  return (
    <div className="w-full h-screen flex items-center justify-center">
      ...
      <div className="hidden md:flex w-1/2 h-full relative">
        <Image
          src="https://images.pexels.com/photos/6129437/pexels-photo-6129437.jpeg?auto=compress&cs=tinysrgb&w=1260&h750dpr=1"
          width={1000}
          height={1000}
          alt="Doctors"
        ...
        <div className="absolute top-0 w-full h-full bg-black bg-opacity-40 z-10 flex flex-col items-center justify-center">
          ...
          <p className="text-blue-900 text-base">You're welcome</p>
        </div>
      </div>
    </div>
  );
